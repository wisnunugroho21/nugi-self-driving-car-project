...
class CnnModel(nn.Module):
    def __init__(self):
      ...
      self.conv3 = nn.Sequential(
        DepthwiseSeparableConv2d(16, 16, kernel_size = 8, stride = 4, padding = 2),
        nn.ReLU(),
      )
      ...
      self.conv6 = nn.Sequential(
        DepthwiseSeparableConv2d(32, 32, kernel_size = 8, stride = 4, padding = 2),
        nn.ReLU(),
      )
      ...
      self.conv9 = nn.Sequential(
        DepthwiseSeparableConv2d(64, 64, kernel_size = 8, stride = 4, padding = 2),
        nn.ReLU(),
      )
