...
class AgentImageStatePPGSharedCnn(AgentPPG):
    def __init__(self, projector, cnn, policy, value, state_dim, action_dim, distribution, ppo_loss, aux_ppg_loss, ppo_memory, aux_ppg_memory, 
        ...
        self.cnn.load_state_dict(torch.load(self.folder + '/cnn.pth'))
